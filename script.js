...
var check;
Promise.all([img2matrix.fromUrl("https://upload.wikimedia.org/wikipedia/commons/5/57/Heightmap.png", sizeX, sizeY, minHeight, maxHeight)()]).then(function (data) {
  var matrix = data[0];
  ...
  check = function () {
    ...
    //position objects ontop of the terrain
    flagLocation.position.y = intersects2 && intersects2[0] ? intersects2[0].point.y + 0.5 : 30;
